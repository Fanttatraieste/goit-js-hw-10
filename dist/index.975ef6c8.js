...
let fetchCountries = (userInput)=>{
    fetch("https://restcountries.com/v3.1/name/" + userInput).then((res)=>res.json()) //primesc un string, pe care il transform in format json
    .then((data)=>{
...
const createList = (foundCountries)=>{
    ...
    if (foundCountries.length == 1) {
        ...
        for(key in languagesObject)languagesList.push(languagesObject[key]);
...
},{"./css/styles.css":"1CY4s","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
